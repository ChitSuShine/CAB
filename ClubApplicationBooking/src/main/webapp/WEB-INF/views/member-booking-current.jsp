...
<form:form method="GET"
	action="${pageContext.request.contextPath}/booking/current">
		...
		<table style="cellspacing: 2; cellpadding: 2; border: 1;">
			...
			<c:forEach var="booking" items="${bookingList}">
				<tr class="listRecord">
					...
					<td align="center"><a
						href="${pageContext.request.contextPath}/member/booking/edit/${booking.bookingId}.html"><spring:message
								code="caption.edit" /></a> <a
						href="${pageContext.request.contextPath}/member/delete/${booking.bookingId}.html"><spring:message
